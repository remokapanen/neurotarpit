...
<li>Hoito traumaattisessa vuodossa yleensä konservatiivinen ja keskittyen vitaalien ja oireiden hoitoon. Leikkaushoito (kraniotomia) tulee kyseeseen vain, jos potilaalla on tSAH:n lisäksi muita leikkaushoitoa vaativia muutoksia, kuten suuri epiduraali- tai subduraalivuoto tai aivoja painava ruhje.</li>
<li>Aneurysmaattisessa vuodossa angiografian perusteella voidaan hoitaa aneurysma ja estää uusintavuoto (endovaskulaarinen tai kirurginen hoito tilanteesta riippuen). Ennen operaatiota on tärkeää hoitaa korkeita verenpaineita ja usein myös annostellaan traneksaamihappoa (ehkäisevät uusintavuotoa). Vasospasmia estämään käytetään nimodipiinia (ei käytetä rutiininomaisesti traumaattisessa SAV:ssa)</li>
...
<li>Aivoverenvuodon hoito on melkein aina konservatiivinen. Neurokirurgista hoitoa tulee harkita mm., jos vuoto on kortikaalinen tai pikkuaivoissa ja sillä on henkeä uhkaava massavaikutus. Aivokammioihin purkautunut vuoto on vakava ja johtaa yleensä likvorikierron häiriöön, jota joudutaan hoitamaan aivokammioon asetetun katetrin (ventrikulostomia, EVD) kautta likvoria dreneeraamalla. Hydrokefaluksen hoito on usein pitkäkestoista.</li>
...
<li>Lasegue on yleensä negatiivinen; voi kyllä olla positiivinenkin. Positiivinen hermovenytyskoe (Lasègue, femoralisvenytys) viittaa prolapsiin, muttei poissulje LSS:ää</li>
...
<li>Tarvittaessa luudutus dekompression yhteydessä, jos selkärangassa on merkittävää epävakautta (esim. nikamasiirtymä)</li>

---

Huom! Kaularangan alueella stenoosi voi aiheuttaa sekä hermojuuren pinteen (radikulopatia) että selkäytimen pinteen (myelopatia); lannerangan alueella ei ole selkäydintä (päättyy viimeistään L1/L2), joten ei ole myelopatiaakaan siellä. 
...
<li>muistitestit (CERAD vanhuksille ensisijainen, MMSE useimmiten edenneissä tapauksissa ja seurannassa; MoCA myös käytössä paljon varsinkin työikäisillä); yleensä muistihoitaja tekee -> esim. Varhan alueella muistisairausselvittelyt tehdään pitkälti muistikeskuksissa (potilaat voivat hakeutua näihin ilman TK-lääkäriäkin)</li>
