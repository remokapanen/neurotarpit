...
<li>Alzheimerin taudissa nähdään MRI:ssä yleisimmin hippokampusatrofiaa. Aivot voivat myös yleisesti atrofioitua -> ventrikkelien ilmeneminen suurempana. Löydökset MRI:ssä ei kuitenkaan ole täysin spesifisiä Alzheimerille, vaikka olisikin tyypillisenä diagnoosia tukeva löydös. Lisäksi voidaan joskus ottaa PET-kuva ja likvortutkimuksia, varsinkin jos potilas on nuori, tilanne on epäselvä tai hatkitaan modifoivia hoitoja.</li>
  <ul>
...
<li>Vaatii kiireellistä MRI-kuvausta ja löydöksen mukaista operatiivista hoitoa</li>
