...
Vaikeassa aivovammassa GCS on 8 puoli tuntia vammasta, PTA on yli viikon ja tajuttomuus on yli 24 tuntia. 
...
GBS-potilaat tulee lähettää päivystykseen, koska se voi nopeasti edetä hengityslihasten heikkouteen ja siten muodostua hengenvaaralliseksi. Päivystyksessä sitten otetaan yleensä peruslabroja (mahdollisesti myös etiologisia selvittelyjä), likvor (proteiinit merkittävästi koholla ja vain lievä valkosolujen kohoaminen (<50) eli albuminosytologinen dissosiaatio), ENMG (ääreishermoston vaurioitumisen merkit yleensä tässä 2-3vk kohdalla havaittavissa) ja usein myös MRI poissulkemaan muita aiheuttajia. Hengitystoimintaa seurataan vähintään parin tunnin välein PEF-mittauksilla. 
...
p.k. alaraajojen ENMG. Onko GBS viittaavaa? 
...
Potilaalla on jo ollut oireita 2vk, joten ENMG:ssä voitaisiin odottaa mahdollisesti jo näkyvän muutoksia. GBS vaurioittaa niin sensorisia kuin motorisia ääreishermoja demyelinoivasti, joten voidaan havaita neurografiassa impulssin hidastumista (aksonivauriossa taas olisi amplitudin alenemista). Mahdollisesti voi olla demyelinaatiosta johtuen johtumiskatkoksia. Vaikeimmissa tapauksissa jopa fibrillaatioita lihaksissa EMG:ssä. GBS:n akuuttivaiheessa nämä muutokset eivät aina tule esille (ENMG yleensä osoittaa vasta 2-3vk kohdalla), mutta ensimmäisiä piirteitä ennen muita voisi olla esim. F-vasteiden väheneminen ja pidentyminen. 
